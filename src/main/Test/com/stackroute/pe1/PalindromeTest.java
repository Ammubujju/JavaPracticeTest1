...
public class PalindromeTest {
    ...
    public void checkPalindrome()
    {
        ...
        assertEquals("test passed", "121 is palindrome and sum of even numbers is less than 25", a);
    ...
    public void checkPNumberIsNotPalindrome()
    {
        ...
        assertEquals("test passed", "1233 is not a palindrome", a);
    ...
    public void checkPNumberIsNotPalindromeAndMoreThanSum()
    {
        ...
        assertEquals("test passed", "568484 is not a palindrome", a);
